...
\newacronym{lsr}{LSR}{Link State Routing}
...
\newacronym{ospf2}{OSPFv2}{Open Shortest Path First version 2}
\newacronym{ospf3}{OSPFv3}{Open Shortest Path First version 3}
