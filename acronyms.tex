...
\newacronym{bum}{BUM}{Broadcast, Unknown Unicast, and Multicast}
\newacronym{carp}{CARP}{Common Address Redundancy Protocol}
\newacronym{ccm}{CCM}{Continuity-Check Message}
\newacronym{cdp}{CDP}{Cisco Discovery Protocol}
\newacronym{cdn}{CDN}{Cat Delivery Network}
\newacronym{cfm}{CFM}{Connectivity Fault Management}
...
\newacronym{epn}{EPN}{Enterprise Private Network}
\newacronym{erspan}{ERSPAN}{Encapsulated Remote Switch Port Analyser}
\newacronym{esi}{ESI}{Ethernet Segment Identifier}
\newacronym{evi}{EVI}{EVPN Instance}
...
\newacronym{frr}{FRR}{Free Range Routing daemon\acroextra{Fast Reroute}}
...
\newacronym{id}{ID}{Identity Document}
\newacronym{ieee}{IEEE}{Institute of Electrical and Electronics Engineers}
\newacronym{ietf}{IETF}{Internet Engineering Task Force}
\newacronym{ig}{IG}{Internet Gateway}
...
\newacronym{ir}{IR}{Ingress Replication}
...
\newacronym{mac-vrf}{MAC-VRF}{VRF table for MAC addresses}
...
\newacronym{naa}{NAA}{(Modern) Network Automation Architecture}
\newacronym{nac}{NAC}{Network Admission Control}
\newacronym{nacl}{NACL}{Network Access Control List}
...
\newacronym{nmt}{NMT}{Network Monitoring Tools}
...
\newacronym{nve}{NVE}{Network Virtualization Endpoint}
\newacronym{nvo}{NVO}{Network Virtualization Overlay}
...
\newacronym{pbs}{PBS}{Proxmox Backup Server}
\newacronym{pbx}{PBX}{Private Branch Exchange}
\newacronym{pdm}{PDM}{Proxmox Datacenter Manager}
\newacronym{pmg}{PMG}{Proxmox Mail Gateway}
\newacronym{pmsi}{PMSI}{Provider Multicast Service Interface}
...
\newacronym{pve}{PVE}{Proxmox Virtual Environment}
...
\newacronym{rd}{RD}{Route Distinguisher}
...
\newacronym{roadm}{ROADM}{Reconfigurable Optical Add-Drop Multiplexer}
...
\newacronym{vni}{VNI}{Virtual Network Identifier }
